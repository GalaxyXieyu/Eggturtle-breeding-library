...
const COPY: Record<'zh' | 'en', HomeCopy> = {
  zh: {
    ...
    brandTitle: '选育溯源档案',
    brandDescription:
      '让种龟档案、配对记录、产蛋批次与孵化进度形成一套清晰、可信、可追溯的繁育记录。',
    heroKicker: '专业繁育管理',
  ...
  en: {
    navLogin: 'Sign in',
    brandEyebrow: 'Breeding Traceability Record',
    brandTitle: 'Breeding Traceability Record',
    brandDescription:
      'Turn breeder profiles, pairing history, egg batches, and hatch progress into one trusted traceability record.',
    heroKicker: 'Professional Breeding Management',
    heroTitleLine1: 'Pro Turtle Breeding',
    heroTitleLine2: 'Digital Operations',
    heroSubtitle:
      'From breeder records and mating history to hatch tracking, build a traceable and collaborative workflow.',
            ...
            {copy.gallery.map((item) => (
              ...
              >
                <Image
                  ...
                  fill
                  sizes={
                    item.large ? '(max-width: 900px) 100vw, 50vw' : '(max-width: 900px) 100vw, 24vw'
                  }
