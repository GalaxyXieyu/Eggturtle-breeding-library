          ...
          <>
            <div className="flex items-center justify-between gap-3">
              ...
              >
                ...
                <ChevronDown
                  size={14}
                  className={`transition-transform ${isListExpanded ? 'rotate-0' : '-rotate-90'}`}
                />
              </button>
            </div>
            ...
            {isListExpanded ? (
              ...
              <div className="rounded-2xl border border-dashed border-neutral-200 bg-neutral-50/70 px-4 py-3 text-xs text-neutral-500">
                交配记录已折叠，点击“展开”查看。
              </div>
            )}
          </>
